...
public class SaltarScreenManager extends DefaultScreenManager {
    public SaltarScreenManager(LevelManager levelManager, ActorManager actorManager, ImageManager imageManager, AnimationConfigManager animationConfigManager, MultiTouchManager multiTouchManager, InputManager inputManager) {
        registerScreen("test", new SaltarLevelScreen(levelManager, actorManager, imageManager, animationConfigManager, multiTouchManager, inputManager));
    }
}
