...
//        Config.renderImageBoundaries = true;
    ...
    protected LunaGameConfig getGameConfig(Luna luna) {
        ...
        gameConfig.setScreenManager(new SaltarScreenManager(luna.getLevelManager(), luna.getActorManager(), luna.getImageManager(), luna.getAnimationConfigManager(), luna.getMultiTouchManager(), luna.getTouchManager(), luna.getInputManager()));
